...
4. Genera una referencia en Library.Tests.csproj hacia Library.csproj, para eso ejecuta el siguiente comando parado en la carpeta de tests: `dotnet add ./Library.Tests/Library.Tests.csproj reference ../Library/Library.csproj`.
